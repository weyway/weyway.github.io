...
document.addEventListener("DOMContentLoaded", () => {
    ...
    (group.overlays || []).forEach(piece => {
        ...
        const correctedCoords = piece.polycoords.map(([x, y]) => [maxY + minY - y, x]);

        console.log("Polygon color:", piece.color, "Coords:", correctedCoords);
        ...
        if (piece.text) polygon.bindTooltip(piece.text, { permanent: false, direction: 'top' });
